...
const subNavItems: { key: keyof SectionMap; labelKey: string }[] = [
    { key: "overview", labelKey: "b2b.subnav.roi" },
    { key: "caseStudies", labelKey: "b2b.subnav.deployments" },
    { key: "specs", labelKey: "b2b.subnav.modularSpecs" },
];
...
export default function B2BTrack({ refs }: Props) {
    ...
    return (
        <Box sx={{ color: THEME.text }}>
            ...
            <Box ref={refs.overview} sx={{ mb: 5 }}>
                ...
                >
                    {t("b2b.overview.title")}
                </Typography>

                <PlaceholderImage alt={t("b2b.overview.imageAlt")} height={320} priority />
            ...
            <Box ref={refs.caseStudies} sx={{ mb: 5 }}>
                ...
                >
                    {/* Card 1 */}
                    <Box sx={{ flex: 1 }}>
                        <PlaceholderImage alt={t("b2b.caseStudies.card1.imageAlt")} height={220} />
                        <Typography
                            sx={{
                        ...
                        >
                            {t("b2b.caseStudies.card1.body")}
                        </Typography>
                    </Box>

                    {/* Card 2 */}
                    <Box sx={{ flex: 1 }}>
                        <PlaceholderImage alt={t("b2b.caseStudies.card2.imageAlt")} height={220} />
                        <Typography
                            sx={{
                                fontFamily: "'Stack Sans Headline', sans-serif",
                                fontWeight: 700,
            ...
            <Box ref={refs.specs} sx={{ mb: 5 }}>
                ...
                <PlaceholderImage alt={t("b2b.specs.imageAlt")} height={200} />
